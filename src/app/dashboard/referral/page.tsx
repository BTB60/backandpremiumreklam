...
import { auth, referrals, type User, type ReferralRecord } from "@/lib/db";
...
export default function ReferralPage() {
  ...
  useEffect(() => {
    ...
    setUser(currentUser);
    setUserReferrals(referrals.getByReferrerId(currentUser.id));
    setLoading(false);
  }, [router]);
      ...
      <main className="pt-20 pb-24 lg:pb-8">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h1 className="text-2xl font-bold text-[#1F2937]">Referral Proqramı</h1>
          </motion.div>

          <ReferralProgram user={user} referrals={userReferrals} />
        </div>
      </main>
